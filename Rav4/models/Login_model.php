...
class Login_Model extends Model
{
    ...
    **/
    public function Login_Result( $username , $pass )
    {
        ...
        # 先取出帳號有沒有存在
        # ----------------------------------------------------------------------
        $sql = "!!SELECT `id`, `pow`, `disabled`, `account`, `pass`, `logcount`, `failcount`, `name`, `phone`, `address` FROM `k_user` WHERE `account` = ? AND `enabled` = 1 LIMIT 1 ";
