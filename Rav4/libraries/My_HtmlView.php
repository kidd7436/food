...
class My_HtmlView extends HtmlView
{
    ...
    **/
    public function Extension_UI_FlootHtmlView()
    {
        ...
        # 檔案路徑
        # ----------------------------------------------------------------------
        $CounterFile = dirname( dirname( dirname(__FILE__) ) ) . DIRECTORY_SEPARATOR . "Rav4"  . DIRECTORY_SEPARATOR . "public" . DIRECTORY_SEPARATOR . "data" . DIRECTORY_SEPARATOR . "counter.dat";
        # ----------------------------------------------------------------------
        # 如果計數器檔案不存在
        # ----------------------------------------------------------------------
