...
class My_HtmlView extends HtmlView
{
    ...
    **/
    public function Extension_UI_HeaderHtmlView()
    {
        ...
        # 檔案路徑
        # ----------------------------------------------------------------------
        $fn = dirname( dirname( dirname(__FILE__) ) ) . DIRECTORY_SEPARATOR . "Player_Area"  . DIRECTORY_SEPARATOR . "public" . DIRECTORY_SEPARATOR . "data" . DIRECTORY_SEPARATOR . "news.txt";
        # ----------------------------------------------------------------------
        # 防呆
        # ----------------------------------------------------------------------
        if( file_exists( $fn ) )
        ...
        (
            ...
            (
                ...
                # 跑馬燈
                # --------------------------------------------------------------
                "MARQUEE" => "<marquee>".$myfile."</marquee>" ,
            ) ,
            true
        );
    }
