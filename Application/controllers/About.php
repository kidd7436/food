...
class About extends Controller
{
    ...
    **/
    public function __construct()
    {
        ...
        # ----------------------------------------------------------------------
        if ( Bootstart::$_lib['My_Power']->isPower( 8 ) === FALSE )
        {
            Core_Redirect( 'Op' );
        }
        # ----------------------------------------------------------------------
        ...
        # 後台圖片存檔路徑
        # ----------------------------------------------------------------------
        $this->imgurl = DEVIL_SYSTEM_PATH . DIRECTORY_SEPARATOR . implode( DIRECTORY_SEPARATOR , array( "Player_Area" , "public" , "images" ,"about" ) ) . DIRECTORY_SEPARATOR;
        # ----------------------------------------------------------------------
        # 重新建構類別
        # ----------------------------------------------------------------------
    ...
    **/
    private function _add( $_id )
    {
        ...
        if( $_id )
        {
            ...
            # 取出指定的餐盒資料
            # ------------------------------------------------------------------
            $dataArr = Bootstart::$_mod[ 'Carousel_Model' ]->getCarouselById( $_id );
            # ------------------------------------------------------------------
            # 防呆
            # ------------------------------------------------------------------
            if( ! $dataArr )
