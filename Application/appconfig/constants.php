<?php if ( ! defined( 'DEVIL_SYS_CORE_PATH' ) ) exit( 'No direct script access allowed' );
    ...
    **/
    ...
    @brief      專案資料夾名稱
    **/
    define( 'DEVIL_APP_PROJECT' , 'Application' );
    ...
    **/
    ...
    @brief      系統預設最高權限帳號
    **/
    define( 'DEVIL_APP_SUPERACCOUNT' , 'admin' );
    ...
    **/
    ...
    @brief      ★★★★★ 預設控制器
    **/
    define( 'DEVIL_APP_DEFAULT_CONTROLLER' , 'Login' );
    ...
    **/
    ...
    @endcond
    **/
            //define( 'DEVIL_APP_Url' , 'http://' . $_SERVER['HTTP_HOST'] . '/food/' . DEVIL_APP_PROJECT . '/' );
